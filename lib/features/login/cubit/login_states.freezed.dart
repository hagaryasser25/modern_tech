...
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$LoginStatesCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
abstract class Loaded<T> implements LoginStates<T> {
...
class __$$InvalidInputImplCopyWithImpl<T, $Res>
    extends _$LoginStatesCopyWithImpl<T, $Res, _$InvalidInputImpl<T>>
...
class _$InvalidInputImpl<T> implements InvalidInput<T> {
  ...
  @override
  String toString() {
    return 'LoginStates<$T>.invalidInput()';
  }
...
abstract class InvalidInput<T> implements LoginStates<T> {
...
class __$$SuccessLoginImplCopyWithImpl<T, $Res>
    extends _$LoginStatesCopyWithImpl<T, $Res, _$SuccessLoginImpl<T>>
...
class _$SuccessLoginImpl<T> implements SuccessLogin<T> {
  ...
  @override
  String toString() {
    return 'LoginStates<$T>.successLogin(data: $data)';
  }
...
abstract class SuccessLogin<T> implements LoginStates<T> {
