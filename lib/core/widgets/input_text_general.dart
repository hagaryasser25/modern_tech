...
class InputTextGeneral extends StatefulWidget {
  ...
  @override
  State<InputTextGeneral> createState() => _InputTextGeneralState();
}

class _InputTextGeneralState extends State<InputTextGeneral> {
