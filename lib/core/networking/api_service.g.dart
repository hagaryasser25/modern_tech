...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://modern-tech.msagencypro.com/';
  }
  ...
  Future<RegisterBodyResponse> register(
    ...
    final _options = _setStreamType<RegisterBodyResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    late RegisterBodyResponse _value;
    try {
      _value = RegisterBodyResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<RegisterBodyResponse> login(LoginBodyRequest loginRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<CheckOtpResponse> checkOtp(CheckOtpRequest checkOtpRequest) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(checkOtpRequest.toJson());
    final _options = _setStreamType<CheckOtpResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<UpdatePasswordResponse> updatePassword(
      UpdatePasswordRequest checkOtpRequest) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
